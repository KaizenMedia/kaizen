...
$(  '.slide-text2'  ).airport([ 'branding', 'design', 'development', 'events']);
...
/*global $:false */
    ...
    scrollwheel: false,
      ...
      map.drawOverlay({
        ...
        layer: 'overlayLayer',
        content: '<div class="overlay"><div class="dot-up-overlay"></div><p><strong>Kaizen Media</strong></p><p><small><strong>Phone:</strong> +91 98416 23060</small></p><div class="overlay_arrow below"></div></div>',
